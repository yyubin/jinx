...
**MySQL First** | **JDK 21+ Required** | **Latest Version: 0.1.0** | **JPA 3.2.0 Supported**
...
```gradle
dependencies {
    annotationProcessor("io.github.yyubin:jinx-processor:0.1.0")
    implementation("io.github.yyubin:jinx-core:0.1.0")
}
```
...
```kotlin
plugins {
    id("io.github.yyubin.jinx") version "0.1.0"
}
```
