...
const config: Config = {
  title: 'Jinx',
  tagline: 'JPA → DDL / Liquibase Migration Generator',
  ...
  organizationName: 'yyubin', // Usually your GitHub org/user name.
  projectName: 'jinx', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/yyubin/jinx/tree/main/website/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Jinx Project. Built with Docusaurus.`,
    },
    prism: {
