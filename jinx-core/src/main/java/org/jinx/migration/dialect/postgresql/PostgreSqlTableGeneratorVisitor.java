...
public class PostgreSqlTableGeneratorVisitor implements TableGeneratorVisitor {

    private final TableGeneratorBuilder builder;

    public PostgreSqlTableGeneratorVisitor(TableGeneratorDialect tgDialect) {
        this.builder = new TableGeneratorBuilder(tgDialect);
    }

    @Override public void visitAddedTableGenerator(TableGeneratorModel tg)                          { builder.add(new TableGeneratorAddContributor(tg)); }
    @Override public void visitDroppedTableGenerator(TableGeneratorModel tg)                        { builder.add(new TableGeneratorDropContributor(tg)); }
    @Override public void visitModifiedTableGenerator(TableGeneratorModel n, TableGeneratorModel o) { builder.add(new TableGeneratorModifyContributor(n, o)); }
