...
public class ColumnModel {
    ...
    @Builder.Default
    private String comment = null; // Added for @Column(comment)
    ...
    @Builder.Default
    private String tableGeneratorName = null;

    @Builder.Default
    private long identityStartValue = 1;

    @Builder.Default
    private int identityIncrement = 1;

    @Builder.Default
    private int identityCache = 0;

    @Builder.Default
    private long identityMinValue = Long.MIN_VALUE;

    @Builder.Default
    private long identityMaxValue = Long.MAX_VALUE;

    @Builder.Default
    private String[] identityOptions = new String[]{};
    ...
    @Builder.Default
    private boolean enumStringMapping = false;
    ...
    @Builder.Default
    private EnumType enumerationType = null; // For @Enumerated
    ...
    @Builder.Default
    private String mapKeyType = null; // e.g., "entity:fieldName" or null

    @Builder.Default
    private String[] mapKeyEnumValues = new String[]{}; // For @MapKeyEnumerated

    @Builder.Default
    private TemporalType mapKeyTemporalType = null; // For @MapKeyTemporal

    @Builder.Default
    private ColumnKind columnKind = ColumnKind.NORMAL;

    @Builder.Default
    private String sqlTypeOverride = null; // For @Column(columnDefinition)
