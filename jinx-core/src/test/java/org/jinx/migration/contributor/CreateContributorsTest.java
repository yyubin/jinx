...
class CreateContributorsTest {
    ...
    private static RelationshipModel rel(String column) {
        return RelationshipModel.builder().column(column).type(RelationshipType.MANY_TO_ONE).referencedTable("member").build();
    }
    ...
    class ConstraintContributorTest {
        ...
        void empty_name_should_throw() {
            ...
            assertThatThrownBy(() -> cc.contribute(new StringBuilder(), mock(Dialect.class)))
